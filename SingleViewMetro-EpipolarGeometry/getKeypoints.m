...
im = imfilter(im,gfil,'replicate');

% compute the derivatives the image
im_x = imfilter(im,[1 0 -1],'replicate');
im_y = imfilter(im,[1 0 -1]','replicate');
...
im_gx2 = imfilter(im_x2,gfil2,'replicate');
im_gy2 = imfilter(im_y2,gfil2,'replicate');
im_gxy = imfilter(im_xy,gfil2,'replicate');
